...
class ExtractFeatures():
    ...
    def compile_bitcoin(self):
        ...
        for n in os.listdir("model_ransomware/rules/Bitcoin"):
            rule = yara.compile("model_ransomware/rules/Bitcoin/" + n)
            rule.save("model_ransomware/rules_compiled/Bitcoin/" + n)
    ...
    def check_bitcoin(self, file):
        for n in os.listdir("model_ransomware/rules/Bitcoin"):
            rule = yara.load("model_ransomware/rules_compiled/Bitcoin/" + n)
            m = rule.match(file)
            if m:
                return 1
            else:
...
def main():
    ...
    # # args = 'C:\Users\User\Desktop\Blockchain-CS540\Blockchain-CS540\backend\server\model_ransomware\calc.exe'
    # print("started")
    # # file = file
